document.addEventListener('DOMContentLoaded', function() {
    ...
    if (contactForm) {
        ...
        contactForm.addEventListener('input', function(e) {
            ...
            if (!input) return;
            if (input.classList.contains(errorClass) || input.classList.contains(successClass)) {
                validateField(input);
            }
        });
        ...
        contactForm.addEventListener('submit', function(e) {
            ...
            function handleError(error) {
                ...
                const existingMsg = contactForm.querySelector('.form-error-message');
                if (existingMsg) existingMsg.remove();
                ...
                setTimeout(function() {
                    const msg = contactForm.querySelector('.form-error-message');
                    if (msg) msg.remove();
                }, 5000);
            }
        });
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '1746aa25-3877-4b70-b342-d3bd212a91ea',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '1746aa25-3877-4b70-b342-d3bd212a91ea';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '1746aa25-3877-4b70-b342-d3bd212a91ea';
